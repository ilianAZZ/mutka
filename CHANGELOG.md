...
## [2.0.0](https://github.com/ilianAZZ/mutka/compare/v1.1.0...v2.0.0) (2026-06-29)
...
* add GitHub Actions workflows for Discord notifications and deployment process ([d303379](https://github.com/ilianAZZ/mutka/commit/d303379d44793188f914637e654a3c3b215dda5f))
* Add hooks for app functionality and state management ([7d644fe](https://github.com/ilianAZZ/mutka/commit/7d644fe2256774f1e762c666ce0be8a4934b675e))
...
* **columns:** introduce custom columns with dynamic width management ([8101cac](https://github.com/ilianAZZ/mutka/commit/8101cacbe4b4da6f43a1348ad8d0c5dc4b5909d3))
...
* Enhance FileList component with resizable columns and improved layout ([7d644fe](https://github.com/ilianAZZ/mutka/commit/7d644fe2256774f1e762c666ce0be8a4934b675e))
* Enhance settings panel with navigation and module integration, add WebDAV and SQLite community modules in documentation ([7a20dcc](https://github.com/ilianAZZ/mutka/commit/7a20dcce2368fc60ab6188897321a15e1fdd65cf))
...
* implement "Open With" functionality and native drag support ([d797292](https://github.com/ilianAZZ/mutka/commit/d797292d1a20f0f480cf013c603e29852f2e63e2))
* implement changeset-based versioning system with pre-commit checks and release workflow ([1287568](https://github.com/ilianAZZ/mutka/commit/128756857dd7a343c8f24a446093610f861f07aa))
* Implement HomeStore and SettingsStore for app state management ([7d644fe](https://github.com/ilianAZZ/mutka/commit/7d644fe2256774f1e762c666ce0be8a4934b675e))
* Implement sandbox builtins for home directory and settings management ([7d644fe](https://github.com/ilianAZZ/mutka/commit/7d644fe2256774f1e762c666ce0be8a4934b675e))
* initialize website landing page and documentation ([358aee0](https://github.com/ilianAZZ/mutka/commit/358aee06ea08a374d54e64bbc1e513a7a017bf56))
* Introduce Toolbar component for navigation and actions ([7d644fe](https://github.com/ilianAZZ/mutka/commit/7d644fe2256774f1e762c666ce0be8a4934b675e))
...
* **modules:** implement module lifecycle management and UI integration ([9f31bce](https://github.com/ilianAZZ/mutka/commit/9f31bcecce8c6248a6b9457bdb60c1c10eb3999a))
...
* **release:** bypass changeset hook for the release commit ([d7f6c41](https://github.com/ilianAZZ/mutka/commit/d7f6c416ed992ac0c17a67d094fe3860a97e9e0f))
...
* update deploy workflow to use GITHUB_TOKEN for authentication and adjust permissions ([d6119fa](https://github.com/ilianAZZ/mutka/commit/d6119fafcb6829e3ed916564f65ee96b187319ab))
* update Dockerfile and package.json for reproducible builds and correct pnpm version ([1765765](https://github.com/ilianAZZ/mutka/commit/17657652ebbb29eb54e4941b6cbcc7b9b71c2e87))
